...
curl -o /etc/yum.repos.d/jhyub-supergfxctl-plasmoid-fedora-40.repo https://copr.fedorainfracloud.org/coprs/jhyub/supergfxctl-plasmoid/repo/fedora-40/jhyub-supergfxctl-plasmoid-fedora-40.repo
